                    ...
                    >
                        ...
                        <div
                            className={clsx(
                                ...
                                isCompletedStep ? "text-teal-400" : "text-gray-200",
                            )}
                        >
                            {step.title}
                        </div>
                        ...
                        {!isLastStep && (
                            <div
                                className={clsx(
                                    "mr-2 flex-auto border-t-2 border-dotted",
                                    isCompletedStep ? "border-teal-400" : "border-gray-200",
                                )}
                            />
                        )}
                    </div>
