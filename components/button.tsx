...
const buttonVariants = cva("inline-flex items-center justify-center rounded-lg text-sm transition-colors", {
    variants: {
        variant: {
            primary:
                "text-gray-50 bg-gray-950 hover:bg-teal-400 active:bg-teal-500 disabled:text-gray-200 disabled:bg-gray-100",
            accent: "border text-gray-50 bg-teal-400 border-teal-400 hover:bg-teal-500 hover:border-teal-500 active:bg-teal-600 active:border-teal-600 disabled:text-gray-200 disabled:bg-white disabled:border-gray-200",
            secondary: clsx(
